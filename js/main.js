...
(function(html) {
    ...
    * ------------------------------------------------------ */
    ...
    window.addEventListener('scroll', function() {
        ...
        if (sectionPosition < window.innerHeight - 100) { // Adjust when you want the animation to trigger
    ...
    window.addEventListener('scroll', function() {
        var expertiseSection = document.getElementById('experties');
        var sectionPosition = expertiseSection.getBoundingClientRect().top;
    
        if (sectionPosition < window.innerHeight - 100) { // Adjust when you want the animation to trigger
            expertiseSection.classList.add('scrolled');
        } else {
            expertiseSection.classList.remove('scrolled');
        }
    });
    window.addEventListener('scroll', function() {
        var clientsSection = document.getElementById('clients');
        var clientsPosition = clientsSection.getBoundingClientRect().top;
        var projectItems = document.querySelectorAll('.project-item');
    
        // Trigger animation for the clients section
        if (clientsPosition < window.innerHeight - 100) {
            clientsSection.classList.add('scrolled');
        } else {
            clientsSection.classList.remove('scrolled');
        }
    
        // Trigger animation for each project item
